...
public class DBService {
	...
	public void instanciaDB() {
		...
		Tecnico tec1 = new Tecnico(null, "Valdir Cezar", "636.532.302-68", "valdir@mail.com", encoder.encode("123"));
		tec1.addPerfil(Perfil.ADMIN);
		Tecnico tec2 = new Tecnico(null, "Richard Atallman", "903.347.070-56", "stallman@mail.com", encoder.encode("123"));
		Tecnico tec3 = new Tecnico(null, "Claude Elwood Shannonr", "271.068.470-54", "shannon@mail.com", encoder.encode("123"));
		...
		Cliente cli3 = new Cliente(null, "Charlie Darwin", "792.043.830-62", "darwin@mail.com", encoder.encode("123"));
